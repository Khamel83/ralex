...
class WebSessionManager:
    ...
    def get_or_create_session(
        self, session_id: str = None, initial_budget: float = 5.0
    ...
    def get_session_budget_status(self, session_id: str) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "recent_transactions": session.budget.transactions[
                -5:
            ],  # Last 5 transactions
            "transaction_count": len(session.budget.transactions),
        }

    def add_budget_to_session(
        ...
        with self._lock:
            ...
            return {
                ...
                "average_messages_per_session": round(
                    total_messages / max(total_sessions, 1), 1
                ),
            }
